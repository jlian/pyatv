...
_PROTOCOLMESSAGE_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WAKE_DEVICE_MESSAGE', index=32, number=41,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SEND_PACKED_VIRTUAL_TOUCH_EVENT_MESSAGE', index=33, number=43,
      options=None,
      type=None),
  ],
